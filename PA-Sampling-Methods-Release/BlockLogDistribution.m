...
for i=1:length(Factors)
  Factor_i=F(Factors(i));
  C=setdiff(Factor_i.var, V);
  E=[C' A(C)'];
  Factor_i = ObserveEvidence(Factor_i, E);
  Factor_i = FactorMarginalization(Factor_i, C);
  AssignmentIndx=(1:d)'*ones(1,length(Factor_i.var));
  LogBS=LogBS+log(GetValueOfAssignment(Factor_i,AssignmentIndx));
endfor
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
