...
if isDominant == 1
  phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[[1,1];[1,2];[2,3]],1);
  phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[[1,3];[2,1];[2,2]],0);
else
  phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[[1,1];[1,2];[2,3]],0);
  phenotypeFactor = SetValueOfAssignment(phenotypeFactor,[[1,3];[2,1];[2,2]],1);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%