...
for i=1:2*numPeople
  if i <= numPeople
    ...
    if (parents(1) == 0) && (parents(2) == 0)
      temp = genotypeGivenAlleleFreqsFactor(alleleFreqs, i);
    else
      temp = genotypeGivenParentsGenotypesFactor(numAlleles, i, parents(1), parents(2));
    end
  else
    temp = phenotypeGivenGenotypeFactor(alphaList, i-numPeople, i);
  end
  factorList(i) = temp;
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  